...
Load packages and the main functions of the `sfc` package (under construction):
...
We are ready to load the `networkD3` package. I do recommend [this article](https://towardsdatascience.com/using-networkd3-in-r-to-create-simple-and-clear-sankey-diagrams-48f8ba8a4ace) as it was the best tutorial I found on the internet on how to draw Sankey's diagrams on R.
